...
[Download extension](https://github.com/annaesvensson/yellow-feed/archive/main.zip) and copy zip file into your `system/extensions` folder. Right click if you use Safari.
